...
const MobileHeader = (props /*currentPath: string*/) => {
    ...
    return (
        <>
            <svg xmlns="http://www.w3.org/2000/svg" onClick={() => setShow(true)} className="text-gray-800"
            ...
            {show() ? <div className="absolute left-0 top-0 h-screen w-screen z-30 bg-white/80 backdrop-blur-md flex items-end flex-col justify-between px-16 pt-16 pb-[50%]">
                <svg xmlns="http://www.w3.org/2000/svg" className="text-gray-800" onClick={() => setShow(false)}
                    width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
